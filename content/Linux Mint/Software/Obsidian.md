...
Use Software Manager to install flatpak version
...
| Android                  | ~/OneDrive/Documents/Demian/Obsidian/Tech Vault   |
| Windows                  | \OneDrive\Documents\Demian\Obsidian\Tech Vault`   |
| Android                  | `/Internal storage/Documents/Obsidian/Tech Vault` |
| Remotely Save (OneDrive) | Apps\remotely-save\Tech Vault`                    |
| Quartz                   | `~/quartz/tech`                                   |
